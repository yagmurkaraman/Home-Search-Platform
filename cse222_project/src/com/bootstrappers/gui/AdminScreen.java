...
public class AdminScreen extends Application implements Initializable {
    ...
    private AddAdvertisementAdmin addAdvertisement;
    private selectAdvertisementAdmin selectAdvertisement;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        addAdvertisement = new AddAdvertisementAdmin();
        selectAdvertisement = new selectAdvertisementAdmin();
    ...
    @FXML
    void deleteSelected(ActionEvent event) throws Exception {
        if (!deleteid.getText().isEmpty()) {
            BootStrappers bs = new BootStrappers();
            bs.removeHome(Integer.parseInt(deleteid.getText()), new Admin(null,null,null,null,null,"com.bootstrappers.backend.Admin"));
            fillTable(true, false, null, null);
        }
    }
    ...
    private void fillTable(boolean clear_filters, boolean clear, ArrayList homelist_external, ArrayList<Integer> homelist_external2) {
        ...
        if (clear_filters) {
            ...
            System.out.println(lastlasthomelist.size());
    ...
    void showMineSelected(ActionEvent event) throws Exception {
        fillTable(false,true, MainScreen.bs.ownerHome(MainScreen.admin), null);
    }
