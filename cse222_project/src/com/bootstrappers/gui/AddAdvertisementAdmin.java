...
public class AddAdvertisementAdmin extends Application implements Initializable {
    ...
    public void start(Stage primaryStage) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("AddAdvertisementAdmin.fxml"));
    ...
    void addButtonSelected(ActionEvent event) throws Exception {
        ...
        Home newHome = new Home(roomsbox.getValue().toString(), statusbox.getValue().toString(),
                ...
                adnumber, MainScreen.admin, Integer.parseInt(area.getText()), Integer.parseInt(price.getText()), 100);
